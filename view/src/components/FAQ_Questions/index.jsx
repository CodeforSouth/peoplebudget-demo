...
import { questionsContainer, title, div1, div2, div3, div4 } from './index.module.css';
            ...
            <section className={`${questionsContainer}`}>
                <div className={`${div1}`}>
                    ...
                    <p>
                        ...
                        sunt aliquid debitis laudantium fugit asperiores assumenda natus veritatis
                        vero ab in animi? Ipsam veniam nostrum officiis! Sed, eveniet minus.
                    </p>
                </div>
